...
class GaussianModel:
    ...
    def __init__(self, sh_degree : int, H, W, patch_dim):
        ...
        self.noise_sim = GDTD(H, W, patch_dim).cuda()
    ...
    def restore(self, model_args, training_args):
        ...
        self.noise_sim.load_state_dict(noise_sim_dict),
    ...
    def training_setup(self, training_args):
        ...
        for p in self.noise_sim.parameters():
            l += [{'params': [p], 'lr': 5e-4}]
